...
![WhatsApp API](https://k.top4top.io/p_3474vxte91.jpg)
...
```bash
npm install @fuqiteam/X-Baileys
```

Use the edge version (no guarantee of stability, but latest fixes + features)
```bash
yarn add @fuqiteam/X-Baileys@latest
```

Then import your code using:
```javascript
const { default: makeWASocket } = require("@fuqiteam/X-Baileys")
```
...
```javascript
const makeWASocket = require("@fuqiteam/X-Baileys").default;
const { useMultiFileAuthState } = require("@fuqiteam/X-Baileys");
...
```javascript
const makeWASocket = require("@fuqiteam/X-Baileys").default;
const { DisconnectReason, useMultiFileAuthState } = require("@fuqiteam/X-Baileys");
...
```javascript
const makeWASocket = require("@fuqiteam/X-Baileys").default;
const { makeInMemoryStore } = require("@fuqiteam/X-Baileys");
...
const { downloadMediaMessage, getContentType } = require("@fuqiteam/X-Baileys");
